...
export class ServicesComponent implements OnInit {
  ...
  ngOnInit() {
    this.mySlideImages = ['/assets/img/slider/02.jpg', '/assets/img/slider/11.jpg', '/assets/img/slider/05.jpg', '/assets/img/slider/07.jpg', '/assets/img/slider/04.jpg','/assets/img/slider/08.jpg'];
